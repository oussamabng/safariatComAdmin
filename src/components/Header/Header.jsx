  ...
  return (
    <div className="w-full flex justify-between items-center lg:px-20 px-8 bg-white lg:py-4 py-2 border-b border-gray-400">
      <div className="flex justify-between items-center">
        ...
        <label htmlFor="menu-toggle" className="lg:hidden block point-cursor">
      ...
      <div id="menu" className="hidden lg:flex lg:items-center ">
        <nav>
          <ul className="lg:flex items-center justify-between text-base font-bold text-gray-700 pt-4 lg:pt-0">
            <li>
              <Link to="/" className="lg:p-4 py-3 px-0 block">
                Home
              </Link>
            </li>
            <li>
              <Link to="/services" className="lg:p-4 py-3 px-0 block">
                Service
              </Link>
            </li>
            <li>
              <Link to="/blog" className="lg:p-4 py-3 px-0 block">
                Blog
              </Link>
            </li>
            <li>
              <Link to="/contact" className="lg:p-4 py-3 px-0 block">
                Contact
              </Link>
            </li>
            <li>
              <Link to="/about" className="lg:p-4 py-3 px-0 block">
                About us
              </Link>
            </li>
          </ul>
      ...
      <div className="flex items-center">
        <button className="bg-yellow text-white font-bold py-1 px-5 rounded-full">
          login
        </button>
      </div>
    </div>
