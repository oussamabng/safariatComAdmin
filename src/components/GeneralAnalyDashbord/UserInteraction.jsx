...
class UserInteraction extends Component {
  ...
  componentDidMount = () => {
    ...
    for (let i = 0; i < Object.values(progress).length; i++) {
      Object.values(progress)[i].style.width = `${this.data_regions[i].progress}%`;
    }
  };
  render() {
    ...
    var result = [
      {
        title: "Tunis, Tunisia",
        body: "Af deel pomp soms tijd veel ad. En voorloopig uitgegeven en nu ad verkochten beschikken"
      },
      {
        title: "Tunis, Tunisia",
        body: "Af deel pomp soms tijd veel ad. En voorloopig uitgegeven en nu ad verkochten beschikken"
                  ...
                  <div className="mb-3 card bg-white">
                    ...
                    >
                      ...
                      {this.state.itemsTours.map((elem) => {
                        ...
                        let navClass = isActive ? 'btn btn-alternate bg-white  border-none activeButt cursor-pointer' : 'btn btn-alternate bg-white  border-none cursor-pointer'
                        return (
                          <p name={elem["name"]}
                            className={navClass}
                            scrollChor={elem["scrollChor"]}
                            key={elem["key"]}
                            onClick={(props) => this.setActiveTours(props.currentTarget.attributes[0].nodeValue)}>
                            {elem['name']}
                          </p>
                        )
                      })}
                      ...
                      <div className="set-background-color flex flex-row flex-row justify-between items-center p-3">
                        <div className="flex flex-row justify-start items-center">
                          <div className="widget-content px-1">
                            <img className="imgStyle sec" src={user["picture"]} alt="img" />
                          </div>
                  ...
                  return (
                    (
                      <div className="xl:flex xl:justify-between xl:items-center lg:justify-start xl:flex-row md:py-4 lg:py-4 lg:flex-col">
                        ...
                        <div className="xl:w-1/5 lg:w-full">{region["progress"]}%</div>
                      </div>
